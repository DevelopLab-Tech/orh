        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card mt-5 my-5">
                    ...
                    <div class="card-body">
                        <form action="php/connexionA.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="pseudo">Pseudonyme : </label>
                                <input type="text" class="form-control" name="pseudo" id="pseudo" placeholder="orh..."  required>
