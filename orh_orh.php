    ...
    <div class="corp">
        <div class="row">
            <div class="container">
                ...
                <h6>Présentation, </h6>
                <p>Depuis quelques années de paysage professionnel de notre pays est jalonné par plusieurs entreprises exerçant dans le domaine des Ressources Humaines.
                    <b>ORH</b>: à l’instar des autres entreprises est un cabinet d’assistance et de conseil en stratégie RH, elle regroupe en son sein plusieurs experts du domaine des RH.
                    Désireuse d’offrir à ses partenaires des produits et des services ; des solutions digitales flexibles adaptées aux exigences du marché de la concurrence <b>ORH</b> met à votre disposition une longue expérience  pluridimensionnelle afin de vous aider  à relever chacun de vos défis.
                </p>
                <h5 class="text-uppercase mx-3" style="text-decoration: underline; color: #2baae0;">NOS DOMAINES D’ACTIVITE</h5>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <h5 class="card-header">Telechargerz le document de presentation ORH</h5>
                            <div class="card-body">
                    ...
                    <br>
                    <p class="mx-5">Nos offres couvrent un grand nombre de compétences : coaching, organisation, management, ressources humaines, stratégie, recrutement, bilan comportemental professionnel, développement personnel et ingénierie de projet.</p>
                </div>
